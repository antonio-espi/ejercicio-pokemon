...
const GetPokemons = async (url) => {
    try {
        ...
        btnNext=results.next ? `<button class="btn" data-url=${results.next}>Sigiente</button>` : ''
        btnPrevious=results.previous ? `<button class="btn" data-url=${results.previous}>Atras</button>` : ''
